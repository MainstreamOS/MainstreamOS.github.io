...
const NAV_ORDER = [
  ...
  { group: 'Settings', ids: ['quick','wifi','bluetooth','bar','dock','interface','background','decorations','themes','display','layouts','keyboard','mouse','power','accounts','services','manage','update','recovery','about'] },
